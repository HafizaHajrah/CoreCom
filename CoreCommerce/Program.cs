...
using Stripe;
using CoreBooks.DataAccesses.DbInitializer;
...
{
    options.AppId = "640919335257539";
    options.AppSecret= "2ef364c5b0889eda564bb964c2f41b52";
});
...
app.UseSession();app.UseHttpsRedirection();
app.UseStaticFiles();
